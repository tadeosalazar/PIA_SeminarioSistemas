...
obtener_mensaje_reflexivo(PuntosTotales, Mensaje) :-
    (   PuntosTotales =:= 100 -> Mensaje = 'Felicidades! Obtuviste el puntaje maximo. Estas muy feliz!'
    ;   PuntosTotales =:= 20 -> Mensaje = 'Obtuviste el puntaje minimo. Reflexiona sobre como mejorar.'
    ;   PuntosTotales =< 35 -> Mensaje = 'Tu puntaje es bajo. Tomate un momento para reflexionar.'
    ;   PuntosTotales =< 50 -> Mensaje = 'Tu puntaje es neutral. Reflexiona sobre lo que te hace feliz.'
    ;   PuntosTotales =< 75 -> Mensaje = 'Tu puntaje es alto. Sigue asi!'
    ;   Mensaje = 'Excelente! Obtuviste un puntaje muy alto. Estas muy feliz!'
    ).
